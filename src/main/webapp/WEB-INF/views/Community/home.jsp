...
<body>
    ...
    <section class="bg-half d-table w-100" style="background: url('/resources/images/home/pages.jpg') center center;">
        <div class="bg-overlay" style="background-image: url('/resources/images/bg.png')"></div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="title-heading">
                        <h3 class="text-white">커뮤니티</h3>
    ...
    <section class="section">
     <div class="col-12 text-center">
         <%-- 로그인한 경우 글쓰기 링크 표시 --%>
         <c:if test="${ sessionScope.CustomerNumber != null }">
             <p class="mb-0 mt-3"><a href="/community/save" class="text-dark font-weight-bold">글쓰기</a></p>
         </c:if>
        <%-- 로그인되지 않은 경우 로그인 창으로 이동 --%>
         <c:if test="${sessionScope.CustomerNumber == null}">
             <p class="mb-0 mt-3"><a href="/products/login" class="text-dark font-weight-bold">글 작성을 하려면 로그인을 해야합니다</a></p>
         </c:if>
     </div><!--end col-->
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-7 col-12">
                    <div class="row">
                        <c:forEach items="${communityList}" var="communityList">
                            <div class="col-lg-12 col-12 mb-2 pb-2">
                                <div class="card blog-post border-0 rounded shadow overflow-hidden">
                                    <div class="card-body content p-4">
                                    <small>${communityList.cmntyType} <span class="mdi mdi-eye"></span>${communityList.cmntyView} ${communityList.cmntyCreateDate}</small>
                                    <br>
                                        <a href="/community?cmntyNo=${communityList.cmntyNo}" class="title text-dark h5">${communityList.cmntyTitle}</a>
                                        <div class="post-meta d-flex justify-content-between mt-3">
                                            <ul class="list-unstyled mb-0">
                                                <li class="list-inline-item mr-1 mb-0"><a href="javascript:void(0)" class="text-muted like"><i class="mdi mdi-account"></i>${communityList.contactFirstName}</a></li>
                                                <li class="list-inline-item mr-1 mb-0"><a href="javascript:void(0)" class="text-muted like"><i class="mdi mdi-heart-outline mr-1"></i>${communityList.cmntyLike}</a></li>
                                        ...
                                        <div class="col-12">
                                            <ul class="pagination justify-content-center mb-0">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <li class="page-item"><a class="page-link" href="/community/?page=${paging.page-1}&keyword=${param.keyword}&category=${param.category}" aria-label="Previous">Previous</a></li>
                                                    </c:otherwise>
                                                </c:choose>
                                                ...
                                                <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${i eq paging.page}">
                                                            <li class="page-item active"><a class="page-link" href="/community/?page=${i}&keyword=${param.keyword}&category=${param.category}">${i}</a></li>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <li class="page-item"><a class="page-link" href="/community/?page=${i}&keyword=${param.keyword}&category=${param.category}">${i}</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </c:forEach>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <li class="page-item"><a class="page-link" href="/community/?page=${paging.page+1}&keyword=${param.keyword}&category=${param.category}" aria-label="Next">Next</a></li>
                                                    </c:otherwise>
                                                </c:choose>
                                            </ul>
                                        </div>
                    ...
                    <div class="sidebar sticky-sidebar">
                        ...
                        <div class="widget mb-4 pb-2">
                            <div id="search2" class="widget-search mb-0">
                                <form role="/community" method="get" id="searchform" class="searchform">
                                    <div>
                                        <input type="text" class="border rounded" name="keyword" id="keyword" placeholder="검색어를 입력하세요">
                        ...
                        <div class="widget mb-4 pb-2">
                            ...
                            <div class="p-4 mt-4 rounded shadow">
                                <ul class="list-unstyled mb-0 catagory">
                                    <li><a href="/community/?&category=Q&A">Q&A</a> <span class="float-right"></span></li>
                                    <li><a href="/community/?&category=지식">지식공유</a> <span class="float-right"></span></li>
                                    <li><a href="/community/?&category=커뮤니티">커뮤니티</a> <span class="float-right"></span></li>
                                    <li><a href="/community/?&category=프로젝트">프로젝트</a> <span class="float-right"></span></li>
                                    <li><a href="/community/?&category=스터디">스터디</a> <span class="float-right"></span></li>
                                    <li><a href="/community/?&category=채용">채용</a> <span class="float-right"></span></li>
                                </ul>
                            </div>
                        </div>
                        <!-- CATAGORIES -->
                        ...
                        <!-- RECENT POST -->
                        <div class="widget mb-4 pb-2">
                            <h6 class="widget-title">인기 게시글</h6>
                            <div class="p-4 mt-4 rounded shadow">
                                <div class="clearfix post-recent">
                                    <div class="post-recent-thumb float-left"> <a href="jvascript:void(0)"></div>
                                    <div class="post-recent-content float-left"><a href="jvascript:void(0)">개발자라면 놓쳐선 안 될 데일리 AI뉴스</a><span class="text-muted mt-2">15th June, 2019</span></div>
                                </div>
                                <div class="clearfix post-recent">
                                    <div class="post-recent-thumb float-left"> <a href="jvascript:void(0)"></a></div>
                                    <div class="post-recent-content float-left"><a href="jvascript:void(0)">Spring Boot에서 mqtt 설정시</a> <span class="text-muted mt-2">15th June, 2019</span></div>
                                </div>
                                <div class="clearfix post-recent">
                                    <div class="post-recent-thumb float-left"> <a href="jvascript:void(0)"> </a></div>
                                    <div class="post-recent-content float-left"><a href="jvascript:void(0)">Gitbook 에 작성한 "클라우드/해킹/보안/개인정보/취약점진단...</a> <span class="text-muted mt-2">15th June, 2019</span></div>
                                </div>
                            </div>
                        </div>
                        <!-- RECENT POST -->
                        ...
                        <div class="widget mb-4 pb-2">
                            ...
                            <div class="tagcloud p-4 mt-4 rounded shadow">
                                <a href="jvascript:void(0)" class="rounded">Spring</a>
                                <a href="jvascript:void(0)" class="rounded">Java</a>
                                <a href="jvascript:void(0)" class="rounded">Python</a>
                                <a href="jvascript:void(0)" class="rounded">MVC</a>
                                <a href="jvascript:void(0)" class="rounded">java</a>
                                <a href="jvascript:void(0)" class="rounded">React</a>
                                <a href="jvascript:void(0)" class="rounded">Vue.js</a>
                                <a href="jvascript:void(0)" class="rounded">AJAX</a>
                                <a href="jvascript:void(0)" class="rounded">JPA</a>
                            </div>
                        </div>
                        <!-- TAG CLOUDS -->
