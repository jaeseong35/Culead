...
<body>
<div>
<form action="/customers/paging" method="get">
  <input type="text" name="keyword" placeholder="검색어를 입력하세요" value="${not empty param.keyword ? param.keyword : ''}">

<select name="country" id="countrySelect">
  <option value="">-- ${param.country} --</option>
